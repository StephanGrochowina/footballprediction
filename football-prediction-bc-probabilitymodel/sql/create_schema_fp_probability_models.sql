...
CREATE DATABASE `fp_probability_models` /*!40100 DEFAULT CHARACTER SET utf8 */;

-- Create table for mapping estimated scores onto outcome probabilities
...
-- Create table for mapping estimated total goals onto total goals below/above threshold probabilities
