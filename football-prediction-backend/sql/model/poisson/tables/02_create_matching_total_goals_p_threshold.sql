DROP TABLE IF EXISTS `fp_model_poisson`.`matching_total_goals_p_threshold`;
CREATE TABLE `fp_model_poisson`.`matching_total_goals_p_threshold`
(
    `matching_total_goals_id`            bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'pk',
