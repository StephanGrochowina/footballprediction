DROP TABLE IF EXISTS `football_prediction`.`matching_goals_home_away`;
CREATE TABLE  `football_prediction`.`matching_goals_home_away` (
  `matching_home_away_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'pk',
