...
public abstract class AbstractServiceQueryExecution {
...
//    /**
//     * Creates an instance of {@link AbstractServiceQueryExecution}
//     * @param entityManager the entity manager to be used
//     * @throws NullPointerException if {@param entityManager} is null
//     */
//    public AbstractServiceQueryExecution(EntityManager entityManager) {
...
//    }
    ...
    /**
     *
     * @return the entity manager used by this instance
     */
    ...
    private <T> TypedQuery<T> initializeNamedQuery(String queryName, Class<T> resultClass) {
        ...
        return this.getEntityManager().createNamedQuery(queryName, resultClass);
    }
    ...
    private <T> TypedQuery<T> initializeQuery(String query, Class<T> resultClass) {
        ...
        return this.getEntityManager().createQuery(query, resultClass);
    }
