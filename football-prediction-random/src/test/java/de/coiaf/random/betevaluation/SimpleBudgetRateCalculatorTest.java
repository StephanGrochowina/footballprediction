...
public class SimpleBudgetRateCalculatorTest {

    private SimpleBudgetRateCalculator budgetRateCalculator = null;

    @Before
    public void setUp() {
        this.budgetRateCalculator = new SimpleBudgetRateCalculator();
    }
