...
public class BudgetRateCalculatorProbabilityOnValueBetTest {

    private BudgetRateCalculatorProbabilityOnValueBet budgetRateCalculator = null;

    @Before
    public void setUp() {
        this.budgetRateCalculator = new BudgetRateCalculatorProbabilityOnValueBet();
    }
