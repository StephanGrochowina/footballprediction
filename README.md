...
- football-prediction-addon: addon module, custom server and client side code 
- football-prediction-ui: main application module
- football-prediction-backend: backend module, contains any server side java code and dependencies
